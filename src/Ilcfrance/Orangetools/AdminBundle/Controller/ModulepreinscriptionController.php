...
class ModulepreinscriptionController extends SasedevController
{
	...
	public function listByModuleformationAction($id)
	{
		...
		$this->setBrowserPageTitle($this->translate('ilcfrance.orangetools.admin.Modulepreinscription.listByModuleformation.browserpagetitle', array(
			'%moduleformation%' => $moduleformation->getCode()
		)));
		$this->setPageTitle($this->translate('ilcfrance.orangetools.admin.Modulepreinscription.listByModuleformation.pagetitle', array(
			'%moduleformation%' => $moduleformation->getCode()
		)));
	...
	public function listByTraineeAction($id)
	{
		...
		$this->setBrowserPageTitle($this->translate('ilcfrance.orangetools.admin.Modulepreinscription.listByTrainee.browserpagetitle', array(
			'%user%' => $trainee->getFullName()
		)));
		$this->setPageTitle($this->translate('ilcfrance.orangetools.admin.Modulepreinscription.listByTrainee.pagetitle', array(
			'%user%' => $trainee->getFullName()
		)));
	...
	public function addPostAction()
	{
		...
		if (isset($reqData['ModulepreinscriptionNewForm'])) {
			...
			if ($modulepreinscriptionNewForm->isValid()) {
				...
				return $this->redirect($this->generateUrl('ilcfrance_orangetools_admin_modulepreinscription_editGet', array(
	...
	public function deleteAction($id)
	{
		...
		try {
			...
			if (null == $modulepreinscription) {
				...
				$this->addFlash('success', $this->translate('ilcfrance.orangetools.admin.Modulepreinscription.delete.success', array(
					'%moduleformation%' => $modulepreinscription->getModuleformation()->getCode(),
					'%user%' => $modulepreinscription->getUser()->getFullName()
				)));
			}
	...
	public function editGetAction($id)
	{
		...
		try {
			...
			if (null == $modulepreinscription) {
				...
				$this->setBrowserPageTitle($this->translate('ilcfrance.orangetools.admin.Modulepreinscription.edit.browserpagetitle', array(
					'%moduleformation%' => $modulepreinscription->getModuleformation()->getCode(),
					'%user%' => $modulepreinscription->getUser()->getFullName()
				)));
				$this->setPageTitle($this->translate('ilcfrance.orangetools.admin.Modulepreinscription.edit.pagetitle', array(
					'%moduleformation%' => $modulepreinscription->getModuleformation()->getCode(),
					'%user%' => $modulepreinscription->getUser()->getFullName()
				)));

				$dm = $this->container->get('doctrine_mongodb')->getManager();
				$traces = $dm->getRepository('IlcfranceOrangetoolsDataBundleMongodb:Trace')->getAllByEntityId($modulepreinscription->getId(), Trace::AE_Modulepreinscription);
			...
			if (null == $modulepreinscription) {
				...
				if (isset($reqData['ModulepreinscriptionUpdateModuleformationForm'])) {
					...
					if ($modulepreinscriptionUpdateModuleformationForm->isValid()) {
						$em->persist($modulepreinscription);
						$em->flush();
						$this->addFlash('success', $this->translate('ilcfrance.orangetools.admin.Modulepreinscription.edit.success', array(
							'%moduleformation%' => $modulepreinscription->getModuleformation()->getCode(),
							'%user%' => $modulepreinscription->getUser()->getFullName()
						)));
