...
class SessioninscriptionController extends SasedevController
{
	...
	public function listBySessionformationAction($id, Request $request)
	{
		...
		$this->setBrowserPageTitle($this->translate('ilcfrance.orangetools.admin.Sessioninscription.listBySessionformation.browserpagetitle', array(
			'%sessionformation%' => $sessionformation->getCode()
		)));
		$this->setPageTitle($this->translate('ilcfrance.orangetools.admin.Sessioninscription.listBySessionformation.pagetitle', array(
			'%sessionformation%' => $sessionformation->getCode()
		)));
	...
	public function listByTraineeAction($id, Request $request)
	{
		...
		$this->setBrowserPageTitle($this->translate('ilcfrance.orangetools.admin.Sessioninscription.listByTrainee.browserpagetitle', array(
			'%user%' => $trainee->getFullName()
		)));
		$this->setPageTitle($this->translate('ilcfrance.orangetools.admin.Sessioninscription.listByTrainee.pagetitle', array(
			'%user%' => $trainee->getFullName()
		)));
	...
	public function addPostAction(Request $request)
	{
		...
		if (isset($reqData['SessioninscriptionNewForm'])) {
			...
			if ($sessioninscriptionNewForm->isValid()) {
				...
				return $this->redirect($this->generateUrl('ilcfrance_orangetools_admin_sessioninscription_editGet', array(
	...
	public function deleteAction($id, Request $request)
	{
		...
		try {
			...
			if (null == $sessioninscription) {
				...
				$this->addFlash('success', $this->translate('ilcfrance.orangetools.admin.Sessioninscription.delete.success', array(
					'%sessionformation%' => $sessioninscription->getSessionformation()->getCode(),
					'%user%' => $sessioninscription->getUser()->getFullName()
				)));
			}
	...
	public function editGetAction($id, Request $request)
	{
		...
		try {
			...
			if (null == $sessioninscription) {
				...
				$this->setBrowserPageTitle($this->translate('ilcfrance.orangetools.admin.Sessioninscription.edit.browserpagetitle', array(
					'%sessionformation%' => $sessioninscription->getSessionformation()->getCode(),
					'%user%' => $sessioninscription->getUser()->getFullName()
				)));
				$this->setPageTitle($this->translate('ilcfrance.orangetools.admin.Sessioninscription.edit.pagetitle', array(
					'%sessionformation%' => $sessioninscription->getSessionformation()->getCode(),
					'%user%' => $sessioninscription->getUser()->getFullName()
				)));

				$dm = $this->container->get('doctrine_mongodb')->getManager();
				$traces = $dm->getRepository('IlcfranceOrangetoolsDataBundleMongodb:Trace')->getAllByEntityId($sessioninscription->getId(), Trace::AE_Sessioninscription);
			...
			if (null == $sessioninscription) {
				...
				if (isset($reqData['SessioninscriptionUpdateSessionformationForm'])) {
					...
					if ($sessioninscriptionUpdateSessionformationForm->isValid()) {
						$em->persist($sessioninscription);
						$em->flush();
						$this->addFlash('success', $this->translate('ilcfrance.orangetools.admin.Sessioninscription.edit.success', array(
							'%sessionformation%' => $sessioninscription->getSessionformation()->getCode(),
							'%user%' => $sessioninscription->getUser()->getFullName()
						)));
