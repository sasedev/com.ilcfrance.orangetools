...
class NewTForm extends AbstractType
{
	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		...
		if (null != $this->moduleformation) {
			...
			$builder->add('moduleformation', EntityidType::class, array(
				...
				'query_builder' => function (ModuleformationRepository $mfr) use ($moduleformation_id) {
					return $mfr->createQueryBuilder('mf')->where('mf.id = :id')->setParameter('id', $moduleformation_id);
				},
				'choice_label' => 'id',
				'multiple' => false,
				'by_reference' => true,
			...
			$builder->add('moduleformation', EntityType::class, array(
				...
				'query_builder' => function (ModuleformationRepository $sfr) {
					return $sfr->createQueryBuilder('mf')->orderBy('mf.code', 'ASC');
				},
