...
class NewTForm extends AbstractType
{
	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		...
		if (null != $this->moduleformation) {
			...
			$builder->add('moduleformation', EntityType::class, array(
				...
				'query_builder' => function (ModuleformationRepository $mfr) {
					return $mfr->createQueryBuilder('mf')->orderBy('mf.code', 'ASC');
				},
		...
		$builder->add('dtStart', TextType::class, array(
			'label' => 'ilcfrance.orangetools.admin.SessionformationNewForm.dtStart.label'
		));

		$builder->add('dtEnd', TextType::class, array(
