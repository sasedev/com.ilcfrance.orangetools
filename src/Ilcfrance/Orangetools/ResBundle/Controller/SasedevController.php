...
class SasedevController extends BaseController
{
	...
	public function __construct()
	{
		...
		// $Jquery1MigrateHincludeJs = new ExternalJavascript(new Src('js/jquery1.hinclude.min.js', true));
		// $Jquery1MigrateHincludeJs->setPrepend('<!--[if lt IE 9]><!-->');
		// $Jquery1MigrateHincludeJs->setAppend('<!--<![endif]-->');
		// $Jquery2MigrateHincludeJs = new ExternalJavascript(new Src('js/jquery2.hinclude.min.js', true));
		// $Jquery2MigrateHincludeJs->setPrepend('<!--[if (gte IE 9) | (!IE)]><!-->');
		// $Jquery2MigrateHincludeJs->setAppend('<!--<![endif]-->');
		$Jquery3MigrateHincludeJs = new ExternalJavascript(new Src('js/jquery3.hinclude.min.js', true));
		...
		$this->addHeadScript($Jquery3MigrateHincludeJs);
		...
		<!--
		$(function() {
			$("a[data-targetblank]").on('click', function(e) {
